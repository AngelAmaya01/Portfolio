...
const translations = {
  es: {
    ...
    credifacRole: 'Desarrollador de sistemas',
    ...
    successMessage: 'Tu mensaje fue enviado correctamente. Te responderé pronto.',
    errorMessage: 'No se pudo enviar el mensaje. Por favor intenta de nuevo.',
    sendAnother: 'Enviar otro mensaje',
    // Footer
    footerDesc: 'Ingeniero en Sistemas especializado en desarrollo full-stack y gestión de TI.',
  ...
  en: {
    ...
    // Footer
    footerDesc: 'Systems Engineer specialized in full-stack development and IT management.',
