...
const translations = {
  es: {
    ...
    hello: 'Hola, soy',
    fullStackDev: 'Desarrollador',
    webDev: 'Desarrollo Web',
    apiIntegration: 'Integración de APIs',
    backendDev: 'Desarrollo Backend',
    heroDescription: 'Desarrollador apasionado de Honduras con experiencia en la construcción de aplicaciones web modernas. Especializado en crear interfaces responsivas y amigables con React y desarrollar soluciones backend robustas.',
    aboutMe: 'Sobre Mí',
  ...
  en: {
    ...
    heroDescription: 'Passionate developer from Honduras with experience building modern web applications. Specialized in creating responsive and user-friendly interfaces with React and developing robust backend solutions.',
    aboutMe: 'About Me',
